...
const products = [
    ...
    {
        id: 7,
        nombre: "Terrario Dodecaedro.",
        precio: 30000,
        imagen: "producto7.PNG",
        descripcion:
            "Tenemos tres estilos de vidrio: triangular, cúbico y dodecaedro. Cada uno se puede fabricar con cactus o suculentas.",
    },
    {
        id: 8,
        nombre: "Cactus viejito",
        precio: 50000,
        imagen: "producto8.PNG",
        descripcion:
            "El Cactus cabeza de viejo es una especie muy llamativa, nombrada así debido a los largos cabellos blancos que le dan la apariencia de una persona de edad",
    },
    {
        id: 9,
        nombre: "Aizoaceae",
        ...
        descripcion:
            "Estas plantas son originarias de zonas desérticas del continente africano. Por lo tanto tienen la capacidad de almacenar agua al igual que las suculentas para poder sobrevivir durante los fuertes veranos.",
    },
];
